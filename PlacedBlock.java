...
public class PlacedBlock {
   ...
   public void breakBlock(int x, int y, double pickPower) {
       double timeToMine = this.durability / pickPower;
       for(int i = 0; i < Math.floor(timeToMine); i++) {
           try {
       ...
       System.out.println("It took " + Math.floor(timeToMine) + " hits to mine the block!");
   } 
